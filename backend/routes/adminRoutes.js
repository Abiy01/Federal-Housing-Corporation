...
router.get('/properties/all', getAllPropertiesForAdmin);
...
router.get('/stats/nav', getNavBadgeStats);

// Transaction / rented & sold reports (approved transactions + property counts)
