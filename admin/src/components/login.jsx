      ...
      >
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-16">
            ...
            <div>
              <div className="text-xl font-bold text-[#FAF8F4]">FHC</div>
          ...
          Manage Federal
            <br />
            <span className="text-[#D4755B]">Housing Services</span>
            <br />
            and Operations
          </h1>
          <p className="text-[#9CA3AF] text-base leading-relaxed max-w-xs">
          A powerful admin dashboard to manage properties, requests, payments, leases, and users - all in one place.
          </p>
        </div>
        ...
        <div className="relative z-10 flex items-center gap-2 text-xs text-[#5A5856]">
          ...
          <span>Secured with 256-bit encryption • Federal Housing Commission © 2026</span>
        </div>
      </motion.div>
      ...
      >
        <div className="w-full max-w-md">
          ...
          <div className="flex items-center gap-3 mb-10 lg:hidden">
            ...
            <div className="text-lg font-bold text-[#1C1B1A]"> FHC Admin</div>
          </div>
