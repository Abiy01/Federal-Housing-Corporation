...
import {
  ...
  UserMinus, DollarSign, ClipboardList, ExternalLink, CircleDollarSign,
} from "lucide-react";
import {
  Chart as ChartJS,
...
const Dashboard = () => {
  ...
  const statCards = [
    ...
    },
    {
      ...
      value: stats?.avgPropertyPrice != null ? formatPrice(stats.avgPropertyPrice) : null,
      icon: DollarSign,
      accent: { bg: "bg-purple-50", icon: "text-purple-600" },
      description: "Average listing price",
    },
    {
      title: "Approved deal value",
      value:
        stats?.transactionRevenue != null
          ? formatPrice(stats.transactionRevenue.total ?? 0)
          : null,
      icon: CircleDollarSign,
      accent: { bg: "bg-teal-50", icon: "text-teal-700" },
      description: "Rent + buy transactions (price at approval)",
    },
    {
