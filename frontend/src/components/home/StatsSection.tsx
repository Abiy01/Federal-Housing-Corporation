      ...
      <div className="max-w-[1280px] mx-auto px-8">
        <div className="grid grid-cols-4 divide-x divide-[rgba(212,117,91,0.1)]">
          <div className="text-center">
            ...
            <div className="font-syne font-medium text-sm text-[#6b7280] uppercase tracking-wider">Properties Sold and Rented</div>
          </div>
          <div className="text-center">
          ...
          <div className="text-center">
            <div className="font-space-mono font-bold text-4xl text-[#D4755B] mb-2">10+</div>
            <div className="font-syne font-medium text-sm text-[#6b7280] uppercase tracking-wider">Sub-Cities Covered</div>
          </div>
          <div className="text-center">
