          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <motion.div variants={itemVariants} className="inline-flex items-center gap-3 bg-[rgba(212,117,91,0.1)] border border-[rgba(212,117,91,0.2)] rounded-full px-4 py-2 mb-10">
                ...
                Federal Housing Digital Platform
                </span>
              </motion.div>
              ...
              Find the<br />
                <span className="italic text-[#D4755B]">Right Home</span> with<br />
                Confidence
              </motion.h1>

              {/* Description */}
              <motion.p variants={itemVariants} className="font-manrope font-light text-xl leading-7 text-[#4b5563] mb-12 max-w-[676px]">
              Browse verified listings, compare options, and request viewings with ease. FHC helps you access housing services through a clear, reliable digital process.
              </motion.p>
              ...
              <motion.div variants={itemVariants} className="flex items-center gap-4">
                ...
                Trusted by citizens, tenants, and buyers
                </span>
              </motion.div>
            </motion.div>
                  ...
                  <div className="absolute bottom-6 left-6 right-6 backdrop-blur-md bg-white/90 border border-white/20 rounded-xl p-4 shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1)]">
                    <div className="flex justify-between items-start mb-3">
                      <div>
                        ...
                        <p className="font-space-mono text-xs text-[#6b7280] uppercase tracking-wide">4 Killo, Addis Ababa</p>
                      </div>
                    ...
                    <div className="border-t border-[#e5e7eb] pt-3 flex items-center justify-between">
                      <span className="font-space-mono text-sm text-[#4b5563]">ETB 20,250,000</span>
