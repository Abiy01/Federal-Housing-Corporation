        ...
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-12 md:col-span-8 rounded-2xl overflow-hidden shadow-[0px_20px_25px_-5px_rgba(0,0,0,0.1)] relative group">
            <div className="relative h-[500px]">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8">
                ...
                <h3 className="font-fraunces text-3xl text-white mb-2">City Edge Luxury Villa</h3>
                <p className="font-manrope font-light text-white/80 mb-4">Ayat, Addis Ababa</p>
                <div className="border-t border-white/20 pt-4 flex items-center justify-between">
                  <span className="font-space-mono text-white">ETB 27,800,000</span>
          ...
          <div className="col-span-12 md:col-span-4 rounded-2xl overflow-hidden shadow-[0px_20px_25px_-5px_rgba(0,0,0,0.1)] relative group">
            <div className="relative h-[500px]">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                <h3 className="font-fraunces text-xl text-white mb-1">Skyline Residence Apartment</h3>
                <p className="font-manrope text-sm text-white/70 mb-3">Bole, Addis Ababa</p>
                <span className="font-space-mono text-sm text-white">ETB 14,900,000</span>
              </div>
            </div>
          </div>
          ...
          <div className="col-span-12 md:col-span-4 rounded-2xl overflow-hidden shadow-[0px_20px_25px_-5px_rgba(0,0,0,0.1)] aspect-square">
            <div className="relative h-full">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent" />
              <div className="absolute bottom-0 left-0 right-0 p-6">
                <h3 className="font-fraunces text-xl text-white mb-1">Garden View Family Villa</h3>
                <p className="font-manrope text-sm text-white/70 mb-3">CMC, Addis Ababa</p>
                <span className="font-space-mono text-sm text-white">ETB 18,500,000</span>
              </div>
            </div>
          </div>
          ...
          <div className="col-span-12 md:col-span-8 rounded-2xl overflow-hidden shadow-[0px_20px_25px_-5px_rgba(0,0,0,0.1)] relative">
            <div className="relative h-[800px]">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent" />
              <div className="absolute bottom-0 left-0 right-0 p-8">
                <h3 className="font-fraunces text-2xl text-white mb-2">Hillside Modern Home</h3>
                <p className="font-manrope text-white/70 mb-6">Summit, Addis Ababa</p>
                <div className="border-t border-white/20 pt-6 flex items-center justify-between">
                  <span className="font-space-mono text-white">ETB 22,300,000</span>
