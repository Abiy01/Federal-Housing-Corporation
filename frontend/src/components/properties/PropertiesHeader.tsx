    ...
    <div className="border-b border-[#E6E0DA] bg-white sticky top-0 z-10">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div>
            <h1 className="font-syne text-2xl sm:text-3xl text-[#221410] mb-1">
              All Properties
            </h1>
          ...
          <div className="flex flex-wrap items-center gap-3 sm:gap-4">
            ...
            <div className="flex items-center gap-2 w-full sm:w-auto">
              ...
              <select
                ...
                className="flex-1 sm:flex-none bg-white border border-[#E6E0DA] rounded-lg px-4 py-2 font-manrope text-sm text-[#221410] cursor-pointer focus:outline-none focus:border-[#D4755B] appearance-none pr-8 bg-no-repeat bg-right"
                style={{
