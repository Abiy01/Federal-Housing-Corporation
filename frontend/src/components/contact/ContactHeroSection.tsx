    ...
    <section className="bg-[#F9F7F2] border-b border-[rgba(230,224,218,0.5)] py-20">
      <div className="max-w-[1280px] mx-auto px-8">
        <div className="text-center">
          ...
          Whether you have questions about housing listings, need support with your rental or purchase request, or want help navigating FHC services, our team is ready to assist.
          </p>
        </div>
      </div>
    </section>
