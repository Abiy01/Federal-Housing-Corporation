      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
          ...
          <div className="flex items-center gap-2 self-start sm:self-auto">
            <Link
              to="/my-maintenance"
              className="inline-flex items-center gap-2 border border-[#D4755B] text-[#D4755B] font-manrope font-semibold px-4 py-2.5 rounded-xl hover:bg-[#D4755B] hover:text-white transition-colors"
            >
              Maintenance
            </Link>
            <Link
              to="/add-property"
              className="inline-flex items-center gap-2 bg-[#D4755B] text-white font-manrope font-semibold px-5 py-2.5 rounded-xl hover:bg-[#B86851] transition-colors"
            >
