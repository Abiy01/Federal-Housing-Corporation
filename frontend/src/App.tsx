...
const MyMaintenanceRequestsPage = lazy(() => import('./pages/MyMaintenanceRequestsPage'));
const MyTransactionRequestsPage = lazy(() => import('./pages/MyTransactionRequestsPage'));
const MyRentLeasePage = lazy(() => import('./pages/MyRentLeasePage'));
const MaintenanceDashboardPage = lazy(() => import('./pages/MaintenanceDashboardPage'));
const FinanceAuditPage = lazy(() => import('./pages/FinanceAuditPage'));
    ...
    <>
      ...
      <AnimatePresence mode="wait">
        <Routes location={location} key={location.pathname}>
          ...
          <Route path="/my-maintenance" element={<PageTransition><MyMaintenanceRequestsPage /></PageTransition>} />
          <Route path="/my-transactions" element={<PageTransition><MyTransactionRequestsPage /></PageTransition>} />
          <Route path="/my-rent-leases" element={<PageTransition><MyRentLeasePage /></PageTransition>} />
          <Route path="/maintenance-dashboard" element={<PageTransition><MaintenanceDashboardPage /></PageTransition>} />
          <Route path="/finance-audits" element={<PageTransition><FinanceAuditPage /></PageTransition>} />
